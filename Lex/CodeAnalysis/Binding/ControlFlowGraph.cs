...
namespace Lex.CodeAnalysis.Binding
{
     internal sealed class ControlFlowGraph
    {
        ...
        public sealed class BasicBlockBuilder
        {
            ...
            public List<BasicBlock> Build(BoundBlockStatemnet block)
            {
            ...
            public ControlFlowGraph Build(List<BasicBlock> blocks)
            {
                ...
                for (int i = 0; i < blocks.Count; i++)
                {
                    ...
                    foreach (var statement in current.Statements)
                    {
                        ...
                        {
                            case BoundNodeKind.GotoStatment:
                                var gs = (BoundGotoStatment)statement;
                                var toBlock = _blockFromLabel[gs.Label];
                                Connect(current, toBlock);
                                break;
                            case BoundNodeKind.ConditionalGotoStatment:
                                var cgs = (BoundConditionalGotoStatment)statement;
        ...
        public static ControlFlowGraph Create(BoundBlockStatemnet body)
        {
        ...
        public static bool AllPathsReturn(BoundBlockStatemnet body)
        {
